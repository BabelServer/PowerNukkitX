...
import org.powernukkitx.item.*;
import org.powernukkitx.item.armor.copper.ItemCopperBoots;
import org.powernukkitx.item.armor.copper.ItemCopperChestplate;
import org.powernukkitx.item.armor.copper.ItemCopperHelmet;
import org.powernukkitx.item.armor.copper.ItemCopperHorseArmor;
import org.powernukkitx.item.armor.copper.ItemCopperLeggings;
...
public final class ItemRegistry implements ItemID, IRegistry<String, Item, Class<? extends Item>> {
    ...
    public void init() {
        ...
        try {
            ...
            register(POPLAR_BOAT, ItemPoplarBoat.class);
            register(POPLAR_CHEST_BOAT, ItemPoplarChestBoat.class);
            register(POPLAR_HANGING_SIGN, ItemPoplarHangingSign.class);
            register(POPLAR_SIGN, ItemPoplarSign.class);
            register(WHITE_CUSHION, ItemWhiteCushion.class);
            register(ORANGE_CUSHION, ItemOrangeCushion.class);
            register(MAGENTA_CUSHION, ItemMagentaCushion.class);
            register(LIGHT_BLUE_CUSHION, ItemLightBlueCushion.class);
            register(YELLOW_CUSHION, ItemYellowCushion.class);
            register(LIME_CUSHION, ItemLimeCushion.class);
            register(PINK_CUSHION, ItemPinkCushion.class);
            register(GRAY_CUSHION, ItemGrayCushion.class);
            register(LIGHT_GRAY_CUSHION, ItemLightGrayCushion.class);
            register(CYAN_CUSHION, ItemCyanCushion.class);
            register(PURPLE_CUSHION, ItemPurpleCushion.class);
            register(BLUE_CUSHION, ItemBlueCushion.class);
            register(BROWN_CUSHION, ItemBrownCushion.class);
            register(GREEN_CUSHION, ItemGreenCushion.class);
            register(RED_CUSHION, ItemRedCushion.class);
            register(BLACK_CUSHION, ItemBlackCushion.class);
